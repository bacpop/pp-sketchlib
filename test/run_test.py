...
subprocess.run("python ../sketchlib-runner.py query sparse test_db --threshold 0.01 --require-reciprocity", shell=True, check=True) # checks if can be run
subprocess.run("python ../sketchlib-runner.py query sparse test_db --threshold 0.01 --count-all-neighbours", shell=True, check=True) # checks if can be run
subprocess.run("python ../sketchlib-runner.py query sparse test_db --threshold 0.01 --require-reciprocity --count-all-neighbours", shell=True, check=True) # checks if can be run
subprocess.run("python ../sketchlib-runner.py query sparse test_db --kNN 2 --require-reciprocity", shell=True, check=True) # checks if can be run
subprocess.run("python ../sketchlib-runner.py query sparse test_db --kNN 2 --count-all-neighbours", shell=True, check=True) # checks if can be run
subprocess.run("python ../sketchlib-runner.py query sparse test_db --kNN 2 --require-reciprocity --count-all-neighbours", shell=True, check=True) # checks if can be run
